...
/*Fetching data out from firestore
	constructor()
	{
		super();
		this.state = {
	...
	render () {
		...
		<p> I have done my works using mainly HTML, CSS, Bootstrap, Javascript, React so far. I am just getting familiar with Google`s Firebase and the beta Firestore as well.</p>
		<p>Apart from this music makes my days even more colorful. I am a singer and musician myself (I play and listen mostly blues and hard rock) I love going to concerts as many as I can. Thank you for visiting my page. If you would like to reach me, please do not hesitate and scroll to the contact me section.</p>
		<hr />
